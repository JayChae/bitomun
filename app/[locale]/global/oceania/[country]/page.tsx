...
import { LocaleType, OceaniaCountry } from "@/types";
...
import { oceaniaResources } from "../_resources";

type Props = {
  params: Promise<{ locale: LocaleType; country: OceaniaCountry }>;
};
...
export async function generateStaticParams() {
  const countries: OceaniaCountry[] = [
    "australia",
    "new-zealand",
  ];
...
export default async function OceaniaCountryPage({ params }: Props) {
  ...
  const oceaniaCountries = [
    ...
    { label: t("countries.new-zealand"), value: "new-zealand" as const },
  ];
  ...
  return (
    <div className="relative h-full">
      <ContinentHeader title={t("title")} subtitle="Oceania Region Resources" />
      <div className="flex">
        <CountrySidebar
